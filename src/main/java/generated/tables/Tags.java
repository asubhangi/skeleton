...
public class Tags extends TableImpl<TagsRecord> {
	...
	private static final long serialVersionUID = -139980874;
	...
	/**
	 * The column <code>public.tags.pid</code>.
	 */
	public final TableField<TagsRecord, Integer> PID = createField("pid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
	...
	public List<ForeignKey<TagsRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<TagsRecord, ?>>asList(Keys.FK_RECEIPT);
	}

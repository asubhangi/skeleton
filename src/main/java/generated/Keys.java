...
public class Keys {
	...
	public static final ForeignKey<TagsRecord, ReceiptsRecord> FK_RECEIPT = ForeignKeys0.FK_RECEIPT;
	...
	private static class Identities0 extends AbstractKeys {
		...
		public static Identity<TagsRecord, Integer> IDENTITY_TAGS = createIdentity(Tags.TAGS, Tags.TAGS.PID);
	}
	...
	private static class UniqueKeys0 extends AbstractKeys {
		...
		public static final UniqueKey<TagsRecord> CONSTRAINT_2 = createUniqueKey(Tags.TAGS, Tags.TAGS.PID);
	}

	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<TagsRecord, ReceiptsRecord> FK_RECEIPT = createForeignKey(generated.Keys.CONSTRAINT_F, Tags.TAGS, Tags.TAGS.ID);
	}
}
